...
public:
    ...
    virtual void  AddItemByName(const item& itemdata)=0;
    virtual void  AddItemByPrice(const item& itemdata)=0;
    virtual void DisplayNameAsc()=0;
    virtual void DisplayNameDesc()=0;
    virtual void DisplayPriceAsc()=0;
    virtual void DisplayPriceDesc()=0;
    //
};
...
public:
    ...
    void AddItemByName(const item& ItemData) override{
        AddItemByName(root, ItemData);
    }
    void AddItemByPrice(const item& ItemData) override{
    ...
    void DisplayNameAsc() override{
        DisplayInOrder(root);
    }
    void DisplayNameDesc() override{
        DisplayReverseOrder(root);
    }
    void DisplayPriceAsc() override{
        DisplayInOrder(root);
    }
    void DisplayPriceDesc() override{
        DisplayReverseOrder(root);
    }
...
int main() {
    ...
    Tree* bstByName=new BST();
    Tree* bstByPrice=new BST();
    readItems("try.txt", bstByName);
